...
# load SM data
summary_deltaSM_allyears <- readRDS("data/deltaSM/summary_deltaSM_MMmean.rds")
...
df_merged <- full_join(df_plot %>% dplyr::filter(model_name != "GRACE observations"), # remove GRACE in the original dataframe to avoid repetitions
...
ggsave("IPCC_regions_deltaSM_MMean.png", path = "./", width = 11, height = 6, dpi= 600) # width = 8, height = 15

# save plots for summary figure
saveRDS(plots, "plot_list_SMmax_IPCCregions.rds", compress = "xz")
