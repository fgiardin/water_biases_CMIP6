...
# Focus on missing combinations only
model_scenario_list <- model_scenario_list[c(2,3,5,7), ]

# Process each model-scenario combination sequentially!! (faster to parallelize at the grid-cell level)
